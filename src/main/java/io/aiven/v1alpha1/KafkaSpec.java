...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"authSecretRef","cloudName","connInfoSecretTarget","disk_space","karapace","maintenanceWindowDow","maintenanceWindowTime","plan","project","projectVPCRef","projectVpcId","serviceIntegrations","tags","terminationProtection","userConfig"})
...
public class KafkaSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.aiven.v1alpha1.kafkaspec.AuthSecretRef authSecretRef;

    public io.aiven.v1alpha1.kafkaspec.AuthSecretRef getAuthSecretRef() {
        return authSecretRef;
    }

    public void setAuthSecretRef(io.aiven.v1alpha1.kafkaspec.AuthSecretRef authSecretRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Information regarding secret creation. Exposed keys: `KAFKA_HOST`, `KAFKA_PORT`, `KAFKA_USERNAME`, `KAFKA_PASSWORD`, `KAFKA_ACCESS_CERT`, `KAFKA_ACCESS_KEY`")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.kafkaspec.ConnInfoSecretTarget connInfoSecretTarget;

    public io.aiven.v1alpha1.kafkaspec.ConnInfoSecretTarget getConnInfoSecretTarget() {
        return connInfoSecretTarget;
    }

    public void setConnInfoSecretTarget(io.aiven.v1alpha1.kafkaspec.ConnInfoSecretTarget connInfoSecretTarget) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("karapace")
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Switch the service to use Karapace for schema registry and REST proxy")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    public void setKarapace(Boolean karapace) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.kafkaspec.ProjectVPCRef projectVPCRef;

    public io.aiven.v1alpha1.kafkaspec.ProjectVPCRef getProjectVPCRef() {
        return projectVPCRef;
    }

    public void setProjectVPCRef(io.aiven.v1alpha1.kafkaspec.ProjectVPCRef projectVPCRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.aiven.v1alpha1.kafkaspec.ServiceIntegrations> serviceIntegrations;

    public java.util.List<io.aiven.v1alpha1.kafkaspec.ServiceIntegrations> getServiceIntegrations() {
        return serviceIntegrations;
    }

    public void setServiceIntegrations(java.util.List<io.aiven.v1alpha1.kafkaspec.ServiceIntegrations> serviceIntegrations) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Kafka specific user configuration options")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.kafkaspec.UserConfig userConfig;

    public io.aiven.v1alpha1.kafkaspec.UserConfig getUserConfig() {
        return userConfig;
    }

    public void setUserConfig(io.aiven.v1alpha1.kafkaspec.UserConfig userConfig) {
