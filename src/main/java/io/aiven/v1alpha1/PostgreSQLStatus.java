...
public class PostgreSQLStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.aiven.v1alpha1.postgresqlstatus.Conditions> conditions;

    public java.util.List<io.aiven.v1alpha1.postgresqlstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(java.util.List<io.aiven.v1alpha1.postgresqlstatus.Conditions> conditions) {
