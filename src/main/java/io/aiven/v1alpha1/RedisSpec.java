...
public class RedisSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.aiven.v1alpha1.redisspec.AuthSecretRef authSecretRef;

    public io.aiven.v1alpha1.redisspec.AuthSecretRef getAuthSecretRef() {
        return authSecretRef;
    }

    public void setAuthSecretRef(io.aiven.v1alpha1.redisspec.AuthSecretRef authSecretRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Information regarding secret creation. Exposed keys: `REDIS_HOST`, `REDIS_PORT`, `REDIS_USER`, `REDIS_PASSWORD`")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.redisspec.ConnInfoSecretTarget connInfoSecretTarget;

    public io.aiven.v1alpha1.redisspec.ConnInfoSecretTarget getConnInfoSecretTarget() {
        return connInfoSecretTarget;
    }

    public void setConnInfoSecretTarget(io.aiven.v1alpha1.redisspec.ConnInfoSecretTarget connInfoSecretTarget) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.redisspec.ProjectVPCRef projectVPCRef;

    public io.aiven.v1alpha1.redisspec.ProjectVPCRef getProjectVPCRef() {
        return projectVPCRef;
    }

    public void setProjectVPCRef(io.aiven.v1alpha1.redisspec.ProjectVPCRef projectVPCRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.aiven.v1alpha1.redisspec.ServiceIntegrations> serviceIntegrations;

    public java.util.List<io.aiven.v1alpha1.redisspec.ServiceIntegrations> getServiceIntegrations() {
        return serviceIntegrations;
    }

    public void setServiceIntegrations(java.util.List<io.aiven.v1alpha1.redisspec.ServiceIntegrations> serviceIntegrations) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Redis specific user configuration options")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.redisspec.UserConfig userConfig;

    public io.aiven.v1alpha1.redisspec.UserConfig getUserConfig() {
        return userConfig;
    }

    public void setUserConfig(io.aiven.v1alpha1.redisspec.UserConfig userConfig) {
