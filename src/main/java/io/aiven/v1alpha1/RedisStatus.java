...
public class RedisStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.aiven.v1alpha1.redisstatus.Conditions> conditions;

    public java.util.List<io.aiven.v1alpha1.redisstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(java.util.List<io.aiven.v1alpha1.redisstatus.Conditions> conditions) {
