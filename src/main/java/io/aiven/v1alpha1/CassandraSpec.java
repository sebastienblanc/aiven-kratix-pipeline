...
public class CassandraSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.aiven.v1alpha1.cassandraspec.AuthSecretRef authSecretRef;

    public io.aiven.v1alpha1.cassandraspec.AuthSecretRef getAuthSecretRef() {
        return authSecretRef;
    }

    public void setAuthSecretRef(io.aiven.v1alpha1.cassandraspec.AuthSecretRef authSecretRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Information regarding secret creation. Exposed keys: `CASSANDRA_HOST`, `CASSANDRA_PORT`, `CASSANDRA_USER`, `CASSANDRA_PASSWORD`, `CASSANDRA_URI`, `CASSANDRA_HOSTS`")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.cassandraspec.ConnInfoSecretTarget connInfoSecretTarget;

    public io.aiven.v1alpha1.cassandraspec.ConnInfoSecretTarget getConnInfoSecretTarget() {
        return connInfoSecretTarget;
    }

    public void setConnInfoSecretTarget(io.aiven.v1alpha1.cassandraspec.ConnInfoSecretTarget connInfoSecretTarget) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.cassandraspec.ProjectVPCRef projectVPCRef;

    public io.aiven.v1alpha1.cassandraspec.ProjectVPCRef getProjectVPCRef() {
        return projectVPCRef;
    }

    public void setProjectVPCRef(io.aiven.v1alpha1.cassandraspec.ProjectVPCRef projectVPCRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.aiven.v1alpha1.cassandraspec.ServiceIntegrations> serviceIntegrations;

    public java.util.List<io.aiven.v1alpha1.cassandraspec.ServiceIntegrations> getServiceIntegrations() {
        return serviceIntegrations;
    }

    public void setServiceIntegrations(java.util.List<io.aiven.v1alpha1.cassandraspec.ServiceIntegrations> serviceIntegrations) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.cassandraspec.UserConfig userConfig;

    public io.aiven.v1alpha1.cassandraspec.UserConfig getUserConfig() {
        return userConfig;
    }

    public void setUserConfig(io.aiven.v1alpha1.cassandraspec.UserConfig userConfig) {
