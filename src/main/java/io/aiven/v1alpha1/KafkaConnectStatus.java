...
public class KafkaConnectStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.aiven.v1alpha1.kafkaconnectstatus.Conditions> conditions;

    public java.util.List<io.aiven.v1alpha1.kafkaconnectstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(java.util.List<io.aiven.v1alpha1.kafkaconnectstatus.Conditions> conditions) {
