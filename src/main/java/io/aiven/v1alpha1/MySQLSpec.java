...
public class MySQLSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.aiven.v1alpha1.mysqlspec.AuthSecretRef authSecretRef;

    public io.aiven.v1alpha1.mysqlspec.AuthSecretRef getAuthSecretRef() {
        return authSecretRef;
    }

    public void setAuthSecretRef(io.aiven.v1alpha1.mysqlspec.AuthSecretRef authSecretRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Information regarding secret creation. Exposed keys: `MYSQL_HOST`, `MYSQL_PORT`, `MYSQL_DATABASE`, `MYSQL_USER`, `MYSQL_PASSWORD`, `MYSQL_SSL_MODE`, `MYSQL_URI`, `MYSQL_REPLICA_URI`")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.mysqlspec.ConnInfoSecretTarget connInfoSecretTarget;

    public io.aiven.v1alpha1.mysqlspec.ConnInfoSecretTarget getConnInfoSecretTarget() {
        return connInfoSecretTarget;
    }

    public void setConnInfoSecretTarget(io.aiven.v1alpha1.mysqlspec.ConnInfoSecretTarget connInfoSecretTarget) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.mysqlspec.ProjectVPCRef projectVPCRef;

    public io.aiven.v1alpha1.mysqlspec.ProjectVPCRef getProjectVPCRef() {
        return projectVPCRef;
    }

    public void setProjectVPCRef(io.aiven.v1alpha1.mysqlspec.ProjectVPCRef projectVPCRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.aiven.v1alpha1.mysqlspec.ServiceIntegrations> serviceIntegrations;

    public java.util.List<io.aiven.v1alpha1.mysqlspec.ServiceIntegrations> getServiceIntegrations() {
        return serviceIntegrations;
    }

    public void setServiceIntegrations(java.util.List<io.aiven.v1alpha1.mysqlspec.ServiceIntegrations> serviceIntegrations) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("MySQL specific user configuration options")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.mysqlspec.UserConfig userConfig;

    public io.aiven.v1alpha1.mysqlspec.UserConfig getUserConfig() {
        return userConfig;
    }

    public void setUserConfig(io.aiven.v1alpha1.mysqlspec.UserConfig userConfig) {
