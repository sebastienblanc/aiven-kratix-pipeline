...
public class PostgreSQLSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.aiven.v1alpha1.postgresqlspec.AuthSecretRef authSecretRef;

    public io.aiven.v1alpha1.postgresqlspec.AuthSecretRef getAuthSecretRef() {
        return authSecretRef;
    }

    public void setAuthSecretRef(io.aiven.v1alpha1.postgresqlspec.AuthSecretRef authSecretRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Information regarding secret creation. Exposed keys: `POSTGRESQL_HOST`, `POSTGRESQL_PORT`, `POSTGRESQL_DATABASE`, `POSTGRESQL_USER`, `POSTGRESQL_PASSWORD`, `POSTGRESQL_SSLMODE`, `POSTGRESQL_DATABASE_URI`")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.postgresqlspec.ConnInfoSecretTarget connInfoSecretTarget;

    public io.aiven.v1alpha1.postgresqlspec.ConnInfoSecretTarget getConnInfoSecretTarget() {
        return connInfoSecretTarget;
    }

    public void setConnInfoSecretTarget(io.aiven.v1alpha1.postgresqlspec.ConnInfoSecretTarget connInfoSecretTarget) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.postgresqlspec.ProjectVPCRef projectVPCRef;

    public io.aiven.v1alpha1.postgresqlspec.ProjectVPCRef getProjectVPCRef() {
        return projectVPCRef;
    }

    public void setProjectVPCRef(io.aiven.v1alpha1.postgresqlspec.ProjectVPCRef projectVPCRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.aiven.v1alpha1.postgresqlspec.ServiceIntegrations> serviceIntegrations;

    public java.util.List<io.aiven.v1alpha1.postgresqlspec.ServiceIntegrations> getServiceIntegrations() {
        return serviceIntegrations;
    }

    public void setServiceIntegrations(java.util.List<io.aiven.v1alpha1.postgresqlspec.ServiceIntegrations> serviceIntegrations) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("PostgreSQL specific user configuration options")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.aiven.v1alpha1.postgresqlspec.UserConfig userConfig;

    public io.aiven.v1alpha1.postgresqlspec.UserConfig getUserConfig() {
        return userConfig;
    }

    public void setUserConfig(io.aiven.v1alpha1.postgresqlspec.UserConfig userConfig) {
